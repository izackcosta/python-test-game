...
main_scenario = Scenario([Platform('grass_platform.png', 1, 19, grid),
                ...
                Coin(5, 18, grid, game),
                Coin(7, 18, grid, game),
                Mushroom(5, 18, grid, -1, game),
                Mushroom(8, 18, grid, -1, game),
                ...
                Goblin(0, 11, grid, (4, 0), game),
                MagicFruit(0, 11, grid, game),
                Fly(0, 8, grid, (24, 0), game),
                Fly(24, 8, grid, (0, 24), game),
                ...
                Fly(0, 4, grid, (24, 0), game),
                Fly(24, 4, grid, (0, 24), game),
                Fly(13, 4, grid, (0, 24), game),
                ...
                Goblin(10, 2, grid, (2, 10), game),
                Goblin(2, 2, grid, (10, 2), game),
...
def debug_draw_rect(rect):
    screen.draw.rect(rect, (0,0,255))

game['debug_draw_rect'] = debug_draw_rect